...
Attentionを求める例として，「I like an apple, it is tasty.」という文章を考える．
初めに，文字列「I like an apple, it is tasty.」を入力とする．入力は単語ごとにベクトルに埋め込まれ$x_{1},...,x_{7}$と表し，次元は$d_{model}$で，論文\cite{vaswani2017attention}より512である．
